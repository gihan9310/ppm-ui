        ...
        return (
            <div className ="main-dive">
              ...
              <Row>
                 ...
                 <Col span={16} > <h1>Create New Project</h1></Col>
                 <Col span={4} ></Col>
              </Row>
                ...
                <form onSubmit={this.onSubmit} ref>
                    ...
                    <Row className='form-row'>
                      ...
                      <Col className='form-input' xs={24} sm={12} md={12} lg={12} xl={12}><Input  name="projectId" value={this.state.projectId} onChange={this.onChange} /> <span className='err_mesg'>{errors.projectId}</span></Col>
                    </Row>
                    ...
                    <Col  className='form-label' xs={0} sm={0} md={8} lg={8} xl={8}>  </Col>
                       ...
                       <Button onClick ={this.onSubmit}  type="primary" block> Create </Button>
                      </Col>
                        <Col  className='form-label' xs={12} sm={12} md={4} lg={4} xl={4}>
